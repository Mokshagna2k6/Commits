          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 xl:col-span-7">
              <div className="anim-1">
                <EyebrowLabel>
                  <Sparkles size={10} /> 180+ Services · 13 Domains · Built for India
                </EyebrowLabel>
              </div>
              ...
              <p className="anim-3 text-warm-500 leading-relaxed mb-10 max-w-lg" style={{ fontSize: '1.0625rem' }}>
                India's first Amazon-style tech agency. Browse 180+ individually
        ...
        <div className="container-fx">
          ...
          <div className="text-center mt-10">
            <Link to="/catalog" className="btn-outline text-sm px-6 py-2.5 rounded-xl inline-flex items-center gap-2">
              Browse all 180+ services <ArrowRight size={15} />
            </Link>
          </div>
        </div>
      </section>

...
const QUESTIONS = [
  { key: 'businessType', label: 'What kind of business is this for?', placeholder: 'e.g. Local restaurant, SaaS startup, D2C brand' },
  { key: 'problem', label: 'What problem are you trying to solve?', placeholder: 'e.g. No online presence, manual order tracking' },
  { key: 'existingOrNew', label: 'Is this a new build, or improving something that exists?', placeholder: 'New / Existing — describe briefly' },
  { key: 'usersVolume', label: 'Roughly how many users or how much volume do you expect?', placeholder: 'e.g. 500 visitors/month, 50 orders/day' },
  { key: 'platform', label: 'Mobile, web, or both?', placeholder: 'e.g. Web only, or both iOS and Android' },
  { key: 'payments', label: 'Do you need to accept payments online?', placeholder: 'Yes/No — and how (UPI, cards, subscriptions)?' },
  { key: 'integrations', label: 'Any tools you need this connected to?', placeholder: 'e.g. WhatsApp, Google Sheets, existing CRM' },
  { key: 'budget', label: "What's your rough budget range?", placeholder: 'e.g. Under ₹50K, ₹1-3L, flexible' },
  { key: 'timeline', label: "What's your timeline?", placeholder: 'e.g. ASAP, 1 month, no rush' },
  { key: 'notes', label: 'Anything else we should know?', placeholder: 'Optional — anything not covered above' },
];

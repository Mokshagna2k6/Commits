  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      <div className="bg-[#FAFAF8] rounded-2xl p-8 text-center mb-12">
        ...
        <p className="text-gray-600 mb-6">Answer 5 quick questions and get an instant estimate.</p>
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link to="/builder" className="px-6 py-3 border-2 border-orange-500 text-orange-600 rounded-xl font-semibold hover:bg-orange-50">Open the Builder</Link>
        </div>
      </div>

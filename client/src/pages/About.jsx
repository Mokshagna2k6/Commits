          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white border-2 border-fox-500/20 rounded-3xl p-8 shadow-xl shadow-fox-500/5 relative overflow-hidden">
                ...
                <SolveItem title="Instant Transparent Pricing" desc="180+ services with configurable scope. See the price before you talk to anyone." />
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="bg-white border-2 border-fox-500 rounded-3xl p-8 max-w-2xl shadow-xl shadow-fox-500/5">
                ...
                <p className="text-sm text-warm-600 leading-relaxed mb-8">
                  India's first Amazon-style IT services platform. <strong>180+ configurable services</strong> across 13 categories. End-to-end platform delivery — from requirement to production.
                </p>
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t border-warm-100">
                  {['180+ Services', 'Own Revenue', 'E2E Platform', 'Subsidiary Path'].map(tag => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="max-w-2xl">
            ...
            <RoadmapStep 
              ...
              desc="Own client base, own pipeline, 180+ services live on the platform. Operating independently with structural backing from Artwall Labs." 
              status="done" 
            />
            <RoadmapStep 
              phase="PHASE 3 · NOW" 

...
const tasksByDate = {
  '2026-08-05': [{ title: 'Sprint planning', type: 'meeting' }],
  '2026-08-10': [{ title: 'API review', type: 'review' }],
  '2026-08-14': [{ title: 'Design handoff', type: 'deadline' }],
  '2026-08-20': [{ title: 'Client demo', type: 'meeting' }, { title: 'Deploy staging', type: 'deadline' }],
  '2026-08-22': [{ title: 'Code freeze', type: 'deadline' }],
  '2026-08-28': [{ title: 'Retrospective', type: 'meeting' }],
};
